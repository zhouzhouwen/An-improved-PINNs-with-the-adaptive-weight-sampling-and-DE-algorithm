...
def subAimFunc(args):
    ...
    # node7 = var_set_node[phen[6]]
    # node8 = var_set_node[phen[7]]
    # act1 = phen[6]
    # act2 = phen[7]
    # act3 = phen[8]
    # act4 = phen[9]
    # act5 = phen[10]
    # act6 = phen[11]
    # init_lr = var_set_init_lr[phen[8]]
    ...
    params = ([p for p in net.parameters()] + [log_var_a] + [log_var_b] + [log_var_c] + [log_var_d] + [log_var_e] + [
        log_var_f] + [log_var_g] + [log_var_h] + [log_var_i])
    ...
    for epoch in range(10000):
        ...
        with autocast():
            ...
            # Loss based on PDE
            f_u, f_v, f_e = NS_cylinder(pt_x_collocation, pt_y_collocation, pt_t_collocation, net=net)  # output of f(t,x)
